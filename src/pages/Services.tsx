        ...
        <div className="container-wide relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              ...
              <h2 className="text-white mb-3 drop-shadow-[0_2px_4px_rgba(0,0,0,0.7)]">How We Operate on Site</h2>
              <p className="text-white drop-shadow-[0_1px_2px_rgba(0,0,0,0.5)]">We work with:</p>
            </div>
