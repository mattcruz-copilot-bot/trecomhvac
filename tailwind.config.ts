...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'premium': '0 4px 20px -4px rgba(15, 23, 42, 0.1)',
        'premium-hover': '0 8px 30px -4px rgba(15, 23, 42, 0.15)',
        'premium-dark': '0 4px 20px -4px rgba(0, 0, 0, 0.3)',
